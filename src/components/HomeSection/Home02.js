      ...
      <div className="puja-seva-container">
            ...
            <div className="puja-card">
                ...
                <div className="puja-card-content">
                    ...
                    <p className="puja-card-location"><img className='imhe' alt="sri"  src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fic_puja_venue.d37df969.svg&w=1920&q=75'/>Shree Shanidev Temple, Shani Shingnapur, Maharashtra</p>
                    <p className="puja-card-date"><img className='imhe'  alt="sri"  src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fic_puja_date.2c1b9f4c.svg&w=1920&q=75'/>20 July, Saturday, Ashadha Shukla Chaturdashi</p>
                    </div>
                    <Link to="/pujabooking">
                    <button className="puja-card-button">PARTICIPATE <img  alt="sri"  src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fright_arrow_white.a9b048b0.svg&w=32&q=75'/></button>
                    </Link>
                </div>
            </div>
            ...
            <div className="puja-card">
                ...
                <div className="puja-card-content">
                    ...
                    <div className="puja-card-info">
                    <p className="puja-card-location"><img className='imhe' alt="sri"  src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fic_puja_venue.d37df969.svg&w=1920&q=75'/>Maa Bagalmukhi Temple, Haridwar, Uttarakhand</p>
                    <p className="puja-card-date"><img className='imhe'  alt="sri" src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fic_puja_date.2c1b9f4c.svg&w=1920&q=75'/>21 July, Sunday, Ashadha Shukla Chaturdashi</p>
                    </div>
                    <Link to="/pujabooking">
                    <button className="puja-card-button">PARTICIPATE <img  alt="sri" src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fright_arrow_white.a9b048b0.svg&w=32&q=75'/></button>
                    </Link>
            ...
            <div className="puja-card">
                ...
                <div className="puja-card-content">
                    ...
                    <div className="puja-card-info">
                    <p className="puja-card-location"><img className='imhe'  alt="sri"  src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fic_puja_venue.d37df969.svg&w=1920&q=75'/>Shaktipeth Maa Tarapith Temple, Birbhum, West Bengal</p>
                    <p className="puja-card-date"><img className='imhe'  alt="sri"  src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fic_puja_date.2c1b9f4c.svg&w=1920&q=75'/>20 July, Saturday, Ashadha Shukla Purnima (From 05:59 PM, July 20 to 03::46 PM, july 21 )</p>
                    </div>
                    <Link to="/pujabooking">
                    <button className="puja-card-button">PARTICIPATE <img  alt="sri" src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fright_arrow_white.a9b048b0.svg&w=32&q=75'/></button>
                    </Link>
            ...
            <div className='bottonContainer'>
               <div style={{textAlign:'left'}}>
                ...
                <div>
                    <img className='bottomimage' alt="sri"  src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fimg_showcase_section_family.2d744376.png&w=640&q=75'/>
                </div>
            </div>
      </div>
    </div>
