  ...
  return (
    <div className='mainpoojapage'>
      <div className='history'>
        <img style={{height:'40px', width:'40px'}} alt="sri"  src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fback_arrow.bcf3db22.svg&w=32&q=75'/>
        <h1>Puja History</h1>
      </div>

      <div className='poojapagecontent'>
        <img className='imagepoojapage' alt="sri"  src='https://www.srimandir.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fempty_stack.d683b244.svg&w=128&q=75'/>
